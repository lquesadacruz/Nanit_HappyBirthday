...
val LocalImages.CameraElephant: ImageVector
  get() {
    if (_cameraElephant != null) {
      return _cameraElephant!!
    }
    _cameraElephant =
        Builder(
                name = "CameraElephant",
            ...
            .apply {
              path(
                  fill = SolidColor(Color(0xFFFEBE21)),
                  stroke = null,
...
private var _cameraElephant: ImageVector? = null

@Preview
@Composable
private fun Preview() {
  Box(modifier = Modifier.padding(12.dp)) {
    Image(imageVector = LocalImages.CameraElephant, contentDescription = null)
  }
}
