...
val LocalImages.SmallElephant: ImageVector
  get() {
    if (_smallElephant != null) {
      return _smallElephant!!
    }
    _smallElephant =
        Builder(
                name = "SmallElephant",
...
private var _smallElephant: ImageVector? = null

@Preview
@Composable
private fun Preview() {
  Box(modifier = Modifier.padding(12.dp)) {
    Image(imageVector = LocalImages.SmallElephant, contentDescription = null)
  }
}
