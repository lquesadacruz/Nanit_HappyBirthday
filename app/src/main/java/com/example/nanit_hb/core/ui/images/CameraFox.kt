...
val LocalImages.CameraFox: ImageVector
  get() {
    if (_cameraFox != null) {
      return _cameraFox!!
    }
    _cameraFox =
        Builder(
            ...
            .apply {
              path(
                  fill = SolidColor(Color(0xFF6FC5AF)),
                  stroke = null,
...
private var _cameraFox: ImageVector? = null

@Preview
@Composable
private fun Preview() {
  Box(modifier = Modifier.padding(12.dp)) {
    Image(imageVector = LocalImages.CameraFox, contentDescription = null)
  }
}
