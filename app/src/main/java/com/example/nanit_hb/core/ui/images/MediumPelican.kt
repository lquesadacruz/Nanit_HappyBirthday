...
val LocalImages.MediumPelican: ImageVector
  get() {
    if (_mediumPelican != null) {
      return _mediumPelican!!
    }
    _mediumPelican =
        Builder(
                name = "MediumPelican",
            ...
            .apply {
              ...
              path(
                  ...
                  pathFillType = NonZero) {
                    ...
                    reflectiveCurveTo(45.74f, 69.64f, 45.74f, 99.13f)
...
private var _mediumPelican: ImageVector? = null

@Preview
@Composable
private fun Preview() {
  Box(modifier = Modifier.padding(12.dp)) {
    Image(imageVector = LocalImages.MediumPelican, contentDescription = null)
  }
}
