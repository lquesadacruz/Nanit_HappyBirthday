...
val LocalImages.MediumElephant: ImageVector
  get() {
    if (_mediumElephant != null) {
      return _mediumElephant!!
    }
    _mediumElephant =
        Builder(
                name = "MediumElephant",
...
private var _mediumElephant: ImageVector? = null

@Preview
@Composable
private fun Preview() {
  Box(modifier = Modifier.padding(12.dp)) {
    Image(imageVector = LocalImages.MediumElephant, contentDescription = null)
  }
}
