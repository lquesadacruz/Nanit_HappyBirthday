...
val LocalImages.SmallPelican: ImageVector
  get() {
    if (_smallPelican != null) {
      return _smallPelican!!
    }
    _smallPelican =
        Builder(
                name = "SmallPelican",
...
private var _smallPelican: ImageVector? = null

@Preview
@Composable
private fun Preview() {
  Box(modifier = Modifier.padding(12.dp)) {
    Image(imageVector = LocalImages.SmallPelican, contentDescription = null)
  }
}
